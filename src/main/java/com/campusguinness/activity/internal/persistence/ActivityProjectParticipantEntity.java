...
@Entity @Table(name = "activity_project_participants")
public class ActivityProjectParticipantEntity {
    ...
    @Column(name = "activity_application_id", nullable = false) private UUID activityApplicationId;
    ...
    public UUID getActivityProjectId() { return activityProjectId; } public void setActivityProjectId(UUID v) { activityProjectId = v; }
    public UUID getActivityApplicationId() { return activityApplicationId; } public void setActivityApplicationId(UUID v) { activityApplicationId = v; }
