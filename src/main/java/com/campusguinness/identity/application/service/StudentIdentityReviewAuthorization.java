...
@Component
class StudentIdentityReviewAuthorization {

    private final CurrentActor currentActor;
    private final SchoolAdministrationAccessQuery accessQuery;

    StudentIdentityReviewAuthorization(CurrentActor currentActor, SchoolAdministrationAccessQuery accessQuery) {
        this.currentActor = currentActor;
        this.accessQuery = accessQuery;
    }

    UUID requireSchoolAdmin(UUID schoolId) {
