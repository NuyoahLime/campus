...
class CampusGuinnessUserDetailsTest {
    ...
    @Test void getUserIdReturnsUuid() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "hash", "NORMAL", Set.of(), java.util.List.of(), null);
        assertThat(ud.getUserId()).isEqualTo(USER_ID);
    }

    @Test void getUsernameReturnsLoginName() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "testuser", "hash", "NORMAL", Set.of(), java.util.List.of(), null);
        assertThat(ud.getUsername()).isEqualTo("testuser");
    }

    @Test void getPasswordReturnsHash() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "$2a$12$abcdef", "NORMAL", Set.of(), java.util.List.of(), null);
        assertThat(ud.getPassword()).isEqualTo("$2a$12$abcdef");
    }

    @Test void normalIsEnabledAndNonLocked() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "h", "NORMAL", Set.of(), java.util.List.of(), null);
    ...
    @Test void lockedIsEnabledButNotNonLocked() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "h", "LOCKED", Set.of(), java.util.List.of(), null);
        assertThat(ud.isEnabled()).isTrue();
        assertThat(ud.isAccountNonLocked()).isFalse();
    }

    @Test void disabledNotEnabled() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "h", "DISABLED", Set.of(), java.util.List.of(), null);
        assertThat(ud.isEnabled()).isFalse();
    }

    @Test void pendingActivationNotEnabled() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "h", "PENDING_ACTIVATION", Set.of(), java.util.List.of(), null);
        assertThat(ud.isEnabled()).isFalse();
    }

    @Test void authoritiesPreserved() {
        Set<GrantedAuthority> auths = Set.of(new SimpleGrantedAuthority("ROLE_SUPER_ADMIN"));
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "h", "NORMAL", auths, java.util.List.of(), null);
    ...
    @Test void toStringExcludesPasswordHash() {
        var ud = new CampusGuinnessUserDetails(USER_ID, "u", "secret", "NORMAL", Set.of(), java.util.List.of(), null);
