  ...
  routes: [
    ...
    // Teacher workbench
    {
      ...
      children: [
        ...
        { path: 'responsible', name: 'teacher-responsible', component: () => import('@/views/workbench/TeacherResponsibleProjectList.vue') },
        { path: 'responsible/:activityProjectId', name: 'teacher-responsible-detail', component: () => import('@/views/workbench/TeacherResponsibleProjectDetail.vue') },
        { path: 'scores', name: 'teacher-scores', component: () => import('@/views/workbench/TeacherScoreEntryList.vue') },
