...
const router = createRouter({
  ...
  routes: [
    ...
    // Student workbench
    {
      ...
      children: [
        { path: '', name: 'student-home', component: () => import('@/views/workbench/StudentHomeView.vue') },
        { path: 'activities', name: 'student-activities', component: () => import('@/views/NotImplementedView.vue') },
        { path: 'projects', name: 'student-projects', component: () => import('@/views/NotImplementedView.vue') },
        { path: 'scores', name: 'student-scores', component: () => import('@/views/NotImplementedView.vue') },
    ...
    // Teacher workbench
    {
      ...
      children: [
        { path: '', name: 'teacher-home', component: () => import('@/views/workbench/TeacherHomeView.vue') },
        { path: 'projects', name: 'teacher-projects', component: () => import('@/views/NotImplementedView.vue') },
        { path: 'applications', name: 'teacher-applications', component: () => import('@/views/NotImplementedView.vue') },
