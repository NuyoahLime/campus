<template>
  <div class="swb-layout">
    <el-container>
      <el-aside :width="collapsed ? '64px' : '220px'" class="swb-sidebar">
        ...
        <el-menu :default-active="activeMenu" :collapse="collapsed" router class="sidebar-menu">
          ...
          <el-menu-item index="/student/projects">
            <el-icon><Collection /></el-icon><span>我的参赛项目</span>
          </el-menu-item>
          <el-menu-item index="/student/scores">
            <el-icon><DataLine /></el-icon><span>我的成绩</span>
          </el-menu-item>
          <el-menu-item index="/student/rankings">
            <el-icon><Trophy /></el-icon><span>我的排名</span>
          </el-menu-item>
          <el-menu-item index="/student/appeals">
            <el-icon><Warning /></el-icon><span>我的申诉</span>
          </el-menu-item>
          <el-menu-item index="/student/achievements">
            <el-icon><Medal /></el-icon><span>我的成就</span>
          </el-menu-item>
        </el-menu>
      </el-aside>
      <el-container>
        <el-header class="swb-header" height="56px">
          <div class="header-left"><el-tag>学生</el-tag><span class="user-name">{{ auth.user?.username }}</span></div>
          <div class="header-right">
            <el-button text @click="$router.push('/')">返回公共门户</el-button>
...
<style scoped>
.swb-layout { min-height: 100vh; }
.swb-sidebar { background: #ffffff; border-right: 1px solid #e8ecf1; transition: width 0.3s; }
...
.sidebar-menu .el-menu-item { color: #606266; }
.sidebar-menu .el-menu-item.is-active { color: #409eff; background: #ecf5ff; }
.swb-header { background: #fff; border-bottom: 1px solid #e8ecf1; display: flex; align-items: center; justify-content: space-between; padding: 0 20px; }
.header-left { display: flex; align-items: center; gap: 12px; }
.user-name { font-weight: 500; }
.swb-main { background: #eef4fb; padding: 24px; }
</style>
